          ...
          return (
            <div key={c.region} className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="flex items-center gap-1.5 rounded-full border border-[var(--color-border-strong)] bg-[var(--color-surface-2)] px-2 py-0.5 font-mono text-[10px] uppercase tracking-[0.04em] text-[var(--color-paper)] backdrop-blur-sm">
                  <span className="h-1.5 w-1.5 rounded-full" style={{ backgroundColor: info.color }} />
                  {info.label}
                </span>
              </div>
